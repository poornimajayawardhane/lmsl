        ...
        <div class="row" >
            <div class="col-lg-6">
                <form class="hero-form">
                    <h3 style="color: greenyellow; margin-top: 20px;margin-bottom: 30px"> Bid Form</h3>
                    <input type="text" placeholder="Name of Company">
                    <input type="text" placeholder="Address">
                    <input type="password" placeholder="Telephone Number">
                    <input type="password" placeholder="Email">
                    <input type="email" placeholder="owner">

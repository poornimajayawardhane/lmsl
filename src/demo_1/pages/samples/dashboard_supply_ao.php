                ...
                <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <div class="dropdown-header text-center">
                            ...
                            <p class="mb-1 mt-3 font-weight-semibold">Lalith Sisira Kumara</p>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                <li class="nav-item nav-profile">
                    <a href="#" class="nav-link">
                        ...
                        <div class="text-wrapper">
                            <p class="designation">Supply AO</p>
                        </div>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="dashboard_supply_ao.php">
                    ...
                    <div class="col-md-8">
                        <div class="row grid-margin stretch-card">
                            ...
                            <div class="col-md-6 grid-margin stretch-card" >
                                ...
                                <form method="get" action="ch_input_lot_table.php">
                                    <button class="btn-lg" style="background-color: rgba(0,40,30,0.5); border: #3bd949; font-size: x-large; font-family: 'Times New Roman'; border-radius: 200px ;  " type="submit" shape  > Production </button>

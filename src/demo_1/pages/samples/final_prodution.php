            ...
            <div class="col-md-20 d-flex align-items-stretch grid-margin" >
                <div class="col-12 stretch-card" >
                    <div class="card" style="background: black;opacity: 0.4" >
                        <h4 class="card-title" style="font-size: x-large;"  align="center">Go-Down</h4>
                        ...
                        <table class="table table-striped" >
                            ...
                            <tr>
                                ...
                                <th style="font-size: x-large;color: lightgrey">Zircorn</th>
                                <th style="font-size: x-large;color: lightgrey">Monozite</th>
                                <th style="font-size: x-large;color: lightgrey">Garnet</th>
                                <th style="font-size: x-large;color: lightgrey">Mangnetite</th>
